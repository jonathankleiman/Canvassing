...
The workflow wakes every 15 minutes because GitHub cron schedules are static UTC expressions. The script then gates the real run to the `RUN_TIME_ET` repository variable in `America/Toronto`.
